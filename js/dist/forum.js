...
/* empty/unused harmony star reexport *//* This is part of the ianm/koobid project.
...
function addSummaryExcerpt() {
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_DiscussionListItem__WEBPACK_IMPORTED_MODULE_3___default.a.prototype, 'infoItems', function (items) {
    ...
    if (flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.session.user && !flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.session.user.preferences().showKoobidExcerpts) {
      return;
    }

    var excerptPost = flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.forum.attribute('koobid.excerpt_type') === 'first' ? discussion.firstPost() : discussion.lastPost();
    var excerptLength = flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.forum.attribute('koobid.excerpt_length');
    var richExcerpt = flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.forum.attribute('koobid.rich_excerpts');
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_SettingsPage__WEBPACK_IMPORTED_MODULE_1___default.a.prototype, 'oninit', function () {
    this.showKoobidExcerpts = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_5___default()(this.user.preferences().showKoobidExcerpts);
  });
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_SettingsPage__WEBPACK_IMPORTED_MODULE_1___default.a.prototype, 'settingsItems', function (items) {
    items.add('koobid', flarum_components_FieldSet__WEBPACK_IMPORTED_MODULE_2___default.a.component({
  ...
  flarum_components_SettingsPage__WEBPACK_IMPORTED_MODULE_1___default.a.prototype['summariesItems'] = function () {
    ...
    items.add('summary-excerpts', flarum_components_Switch__WEBPACK_IMPORTED_MODULE_4___default.a.component({
      ...
      onchange: function onchange(value) {
        _this.showKoobidExcerptsLoading = true;

        _this.user.savePreferences({
          showKoobidExcerpts: value
        }).then(function () {
          _this.showKoobidExcerptsLoading = false;
          m.redraw();
        });
      },
...
flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('ianm-koobid', function () {
